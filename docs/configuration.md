...
```none
/sdcard/Android/data/<宿主包名>/Xchat/
├── logs/                     # 运行日志
├── assets/                   # 媒体资源 (需手动创建)
...
- **单用户**: `/data/data/<宿主包名>/files/mmkv/{xchat_prefs,xchat_prefs.crc}`
- **多用户 (如双开微信)**: `/data/user/<宿主安卓用户 ID>/<宿主包名>/files/mmkv/{xchat_prefs,xchat_prefs.crc}`
