...
需要自行搭建配套的已读追踪服务器 (`xchat-read-receipts-server`), 并在功能配置中填写服务器地址。
...
```bash
git clone https://github.com/andyhang1980/Xchat.git
cd ./Xchat/contrib/xchat-read-receipts-server
cargo run --release
```
