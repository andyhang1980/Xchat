...
android {
    ...
    logger.lifecycle(
       ...
       [Xchat] WeChat, now with superpowers
        """
    )
    ...
    defaultConfig {
        ...
        buildConfigField("String", "TAG", "\"Xchat\"")
...
//                "x86"
    ...
    signingConfigs {
        val _storeFile = System.getenv("XCHAT_KEYSTORE_FILE")
            ?: runCatching { project.property("XCHAT_KEYSTORE_FILE") }.getOrNull() as? String?
        val _storePassword = System.getenv("XCHAT_KEYSTORE_PASSWORD")
            ?: runCatching { project.property("XCHAT_KEYSTORE_PASSWORD") }.getOrNull() as? String?
        val _keyAlias = System.getenv("XCHAT_KEY_ALIAS")
            ?: runCatching { project.property("XCHAT_KEY_ALIAS") }.getOrNull() as? String?
        val _keyPassword = System.getenv("XCHAT_KEY_PASSWORD")
            ?: runCatching { project.property("XCHAT_KEY_PASSWORD") }.getOrNull() as? String?
...
val rustProjectDir = file("src/main/rust/xchat-native")
val rustLibName = "libxchat_native.so"
