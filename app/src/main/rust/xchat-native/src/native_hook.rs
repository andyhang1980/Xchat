...
/// `/storage/emulated/0/Android/data/<host-pkg>/Xchat/native_anti_detection_enabled.flag`
...
/// Called by the LSPosed native API the moment `libxchat_native.so` is loaded
