...
#[unsafe(no_mangle)]
pub extern "C" fn Java_io_github_xchat_utils_crash_NativeCrashHandler_installNative(
    env: *mut RawJNIEnv,
    _thiz: jobject,
...
/// Java signature: `()V`
#[unsafe(no_mangle)]
pub extern "C" fn Java_io_github_xchat_utils_crash_NativeCrashHandler_uninstallNative(
    _env: *mut RawJNIEnv,
    _thiz: jobject,
) {
...
/// Java signature: `(I)V`
#[unsafe(no_mangle)]
pub extern "C" fn Java_io_github_xchat_utils_crash_NativeCrashHandler_triggerTestCrashNative(
    _env: *mut RawJNIEnv,
    _thiz: jobject,
    crash_type: jint,
) {
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn Java_io_github_xchat_features_items_chat_MarkdownRendering_convertMarkdownToHtmlNative(
    env: *mut RawJNIEnv,
    _thiz: jobject,
...
#[unsafe(no_mangle)]
pub extern "C" fn Java_io_github_xchat_utils_AudioUtils_mp3ToSilk(
    env: *mut RawJNIEnv,
    _thiz: jobject,
    mp3_path: jstring,
    silk_path: jstring,
...
#[unsafe(no_mangle)]
pub extern "C" fn Java_io_github_xchat_utils_AudioUtils_silkToPcm(
    env: *mut RawJNIEnv,
    _thiz: jobject,
    silk_path: jstring,
    pcm_path: jstring,
...
#[unsafe(no_mangle)]
pub extern "C" fn Java_io_github_xchat_utils_AudioUtils_pcmToMp3(
    env: *mut RawJNIEnv,
    _thiz: jobject,
    pcm_path: jstring,
    mp3_path: jstring,
...
#[unsafe(no_mangle)]
pub extern "C" fn Java_io_github_xchat_utils_AudioUtils_getDurationMs(
    env: *mut RawJNIEnv,
    _thiz: jobject,
    path: jstring,
) -> jlong {
...
#[unsafe(no_mangle)]
pub extern "C" fn Java_io_github_xchat_preferences_TursoPrefsImpl_nativeInit(
    env: *mut RawJNIEnv,
    _thiz: jobject,
    db_path: jstring,
) {
...
#[unsafe(no_mangle)]
pub extern "C" fn Java_io_github_xchat_preferences_TursoPrefsImpl_nativeGetString(
    env: *mut RawJNIEnv,
    _thiz: jobject,
    key: jstring,
    def_value: jstring,
...
#[unsafe(no_mangle)]
pub extern "C" fn Java_io_github_xchat_preferences_TursoPrefsImpl_nativePutString(
    env: *mut RawJNIEnv,
    _thiz: jobject,
    key: jstring,
    value: jstring,
...
#[unsafe(no_mangle)]
pub extern "C" fn Java_io_github_xchat_preferences_TursoPrefsImpl_nativeGetStringSet(
    env: *mut RawJNIEnv,
    _thiz: jobject,
    key: jstring,
) -> jobjectArray {
...
#[unsafe(no_mangle)]
pub extern "C" fn Java_io_github_xchat_preferences_TursoPrefsImpl_nativePutStringSet(
    env: *mut RawJNIEnv,
    _thiz: jobject,
    key: jstring,
    values: jobjectArray,
...
#[unsafe(no_mangle)]
pub extern "C" fn Java_io_github_xchat_preferences_TursoPrefsImpl_nativeGetInt(
    env: *mut RawJNIEnv,
    _thiz: jobject,
    key: jstring,
    def_value: jint,
...
#[unsafe(no_mangle)]
pub extern "C" fn Java_io_github_xchat_preferences_TursoPrefsImpl_nativePutInt(
    env: *mut RawJNIEnv,
    _thiz: jobject,
    key: jstring,
    value: jint,
...
#[unsafe(no_mangle)]
pub extern "C" fn Java_io_github_xchat_preferences_TursoPrefsImpl_nativeGetLong(
    env: *mut RawJNIEnv,
    _thiz: jobject,
    key: jstring,
    def_value: jlong,
...
#[unsafe(no_mangle)]
pub extern "C" fn Java_io_github_xchat_preferences_TursoPrefsImpl_nativePutLong(
    env: *mut RawJNIEnv,
    _thiz: jobject,
    key: jstring,
    value: jlong,
...
#[unsafe(no_mangle)]
pub extern "C" fn Java_io_github_xchat_preferences_TursoPrefsImpl_nativeGetFloat(
    env: *mut RawJNIEnv,
    _thiz: jobject,
    key: jstring,
    def_value: jfloat,
...
#[unsafe(no_mangle)]
pub extern "C" fn Java_io_github_xchat_preferences_TursoPrefsImpl_nativePutFloat(
    env: *mut RawJNIEnv,
    _thiz: jobject,
    key: jstring,
    value: jfloat,
...
#[unsafe(no_mangle)]
pub extern "C" fn Java_io_github_xchat_preferences_TursoPrefsImpl_nativeGetBoolean(
    env: *mut RawJNIEnv,
    _thiz: jobject,
    key: jstring,
    def_value: jboolean,
...
#[unsafe(no_mangle)]
pub extern "C" fn Java_io_github_xchat_preferences_TursoPrefsImpl_nativePutBoolean(
    env: *mut RawJNIEnv,
    _thiz: jobject,
    key: jstring,
    value: jboolean,
...
#[unsafe(no_mangle)]
pub extern "C" fn Java_io_github_xchat_preferences_TursoPrefsImpl_nativeGetBytes(
    env: *mut RawJNIEnv,
    _thiz: jobject,
    key: jstring,
) -> jbyteArray {
...
#[unsafe(no_mangle)]
pub extern "C" fn Java_io_github_xchat_preferences_TursoPrefsImpl_nativePutBytesWithType(
    env: *mut RawJNIEnv,
    _thiz: jobject,
    key: jstring,
    value: jbyteArray,
...
#[unsafe(no_mangle)]
pub extern "C" fn Java_io_github_xchat_preferences_TursoPrefsImpl_nativeContains(
    env: *mut RawJNIEnv,
    _thiz: jobject,
    key: jstring,
) -> jboolean {
...
#[unsafe(no_mangle)]
pub extern "C" fn Java_io_github_xchat_preferences_TursoPrefsImpl_nativeRemove(
    env: *mut RawJNIEnv,
    _thiz: jobject,
    key: jstring,
) {
...
#[unsafe(no_mangle)]
pub extern "C" fn Java_io_github_xchat_preferences_TursoPrefsImpl_nativeClear(
    _env: *mut RawJNIEnv,
    _thiz: jobject,
) {
...
#[unsafe(no_mangle)]
pub extern "C" fn Java_io_github_xchat_preferences_TursoPrefsImpl_nativeGetAllKeys(
    env: *mut RawJNIEnv,
    _thiz: jobject,
) -> jobjectArray {
...
#[unsafe(no_mangle)]
pub extern "C" fn Java_io_github_xchat_preferences_TursoPrefsImpl_nativeGetType(
    env: *mut RawJNIEnv,
    _thiz: jobject,
    key: jstring,
) -> jint {
...
#[unsafe(no_mangle)]
pub extern "C" fn Java_io_github_xchat_utils_SignatureVerifier_nativeVerify(
    env: *mut RawJNIEnv,
    _thiz: jobject,
    context: jobject,
