//package io.github.xchat.features.items.beautify.monet
//
...
//        return buildString {
//            appendLine("id=xchat-monet-engine")
//            appendLine("name=微信莫奈引擎 (Xchat)")
//            appendLine("version=$vn ($vc)")
//            appendLine("versionCode=$vc")
//            appendLine("author=Ujhhgtg")
//            append("description=为微信 $vn 启用动态壁纸取色, 由 Xchat 在运行时生成")
//        }
//    }
//
