...
import io.github.xchat.features.api.ui.WeMomentsContextMenuApi
...
import io.github.xchat.ui.utils.SendIcon
import io.github.xchat.ui.utils.ShareIcon
    ...
    private fun repostMoment(context: WeMomentsContextMenuApi.MomentsContext) {
        ...
        when (data.type) {
            ...
            15, 5 -> { // 视频
                ...
                val tempVideo = activity.externalCacheDir!!.asPath / "xchat_repost_${System.currentTimeMillis()}.mp4"
