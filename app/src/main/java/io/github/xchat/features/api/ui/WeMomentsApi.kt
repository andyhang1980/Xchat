...
import io.github.xchat.features.api.net.models.protobuf.TimelineObjectProto
...
import io.github.xchat.utils.android.Intent
...
import io.github.xchat.utils.reflection.void
...
object WeMomentsApi : ApiFeature(), IResolveDex {
    ...
    fun postTextAndVideo(context: Context, text: String, videoPath: String, thumbPath: String, sdkId: String? = null, sdkAppName: String? = null): Boolean {
        return try {
            val tempVideo = context.externalCacheDir!!.asPath / "xchat_moments_temp_${System.currentTimeMillis()}.mp4"
            val tempVideoPath = tempVideo.absolutePathString()

            val tempThumb = context.externalCacheDir!!.asPath / "xchat_moments_temp_${System.currentTimeMillis()}.png"
