package io.github.xchat.features.items.notifications
...
import io.github.xchat.utils.collections.LruCache
import io.github.xchat.utils.fs.KnownPaths
import io.github.xchat.utils.strings.isGroupChatWxId
import io.github.xchat.utils.strings.replaceEmojis
import io.github.xchat.utils.strings.replaceRichContent
...
object NotificationsEvolved : SwitchFeature(), IResolveDex {
    ...
    private const val ACTION_REPLY = "${PackageNames.WECHAT}.ACTION_XCHAT_REPLY"
    private const val ACTION_MARK_READ =
        "${PackageNames.WECHAT}.ACTION_XCHAT_MARK_READ"
