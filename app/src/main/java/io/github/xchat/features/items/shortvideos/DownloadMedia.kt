...
import io.github.xchat.features.api.ui.WeShortVideosShareMenuApi
import io.github.xchat.features.core.Feature
import io.github.xchat.features.core.SwitchFeature
import io.github.xchat.ui.utils.DownloadIcon
import io.github.xchat.ui.utils.LinkIcon
...
object DownloadMedia : SwitchFeature(),
    ...
    private suspend fun downloadImages(imageUrls: List<String>) = withContext(Dispatchers.IO) {
        imageUrls.forEachIndexed { index, fullUrl ->
            ...
            runCatching {
                ...
                showToastSuspend("已将图片下载到 /sdcard/Download/Xchat/$fileName")
            }
        }
    }
    ...
    private suspend fun downloadAndDecryptVideo(
        ...
        runCatching {
            ...
            showToastSuspend("已将视频下载到 /sdcard/Download/Xchat/$fileName")
        }
    }
