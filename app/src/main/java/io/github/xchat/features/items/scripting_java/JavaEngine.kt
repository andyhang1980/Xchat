...
import io.github.xchat.features.api.core.WeAuthApi
import io.github.xchat.features.api.core.WeContactApi
import io.github.xchat.features.api.core.WeContactLabelApi
...
import io.github.xchat.features.api.core.WePaymentApi
...
import io.github.xchat.utils.BshSnapshotDecompiler
...
import io.github.xchat.utils.reflection.DexKit
import io.github.xchat.utils.reflection.asClass
import io.github.xchat.utils.reflection.asConstructor
import io.github.xchat.utils.reflection.asMethod
import io.github.xchat.utils.reflection.bool
import io.github.xchat.utils.reflection.float
import io.github.xchat.utils.reflection.int
import io.github.xchat.utils.reflection.long
...
object JavaEngine {
    ...
    fun initNameSpace(nameSpace: NameSpace, plugin: JavaPlugin) {
        nameSpace.apply {
            ...
            // WAuxv original: hooks ChatFooter.setUserName | Xchat: same approach via XposedBridge
            setMethod(BshMethod(
            ...
            // getAvatarUrl(wxId, big) → 'big' param not supported by Xchat; defaults to same URL
            setMethod(BshMethod(
            ...
            // Xchat: uses methodGetSendMsgObject + methodPostToQueue (same NetSceneQueue, different entry); equivalent behavior
