package io.github.xchat.activity
...
import io.github.xchat.ui.content.IconButton
import io.github.xchat.ui.content.TextButton
import io.github.xchat.ui.utils.GitHubIcon
import io.github.xchat.ui.utils.TelegramIcon
import io.github.xchat.ui.utils.theme.darkScheme
import io.github.xchat.ui.utils.theme.lightScheme
import io.github.xchat.utils.android.androidUserId
import io.github.xchat.utils.android.getEnabled
...
import io.github.xchat.utils.hook_status.HookStatus
import io.github.xchat.utils.openInSystem
            ...
            Column(
                ...
                ElevatedCard(
                    onClick = {
                        val hostPkg =
                            prefs.getString("host_pkg_name", PackageNames.WECHAT)!!
                        try {
                            startActivity(io.github.xchat.utils.android.Intent {
                ...
                if (showConfirmDeleteModuleDataDialog) {
                    val paths = remember {
                        @Suppress("SdCardPath")
                        listOf(
                            "/data/data/${PackageNames.WECHAT}/files/mmkv/xchat_prefs",
                            "/data/data/${PackageNames.WECHAT}/files/mmkv/xchat_prefs.crc",
                        )
                    }
                ...
                LinkCard(
                    icon = GitHubIcon,
                    title = "GitHub",
                    subtitle = "andyhang1980/Xchat",
                    onClick = { onUrlClick("https://github.com/andyhang1980/Xchat") }
                )
                LinkCard(
                    icon = TelegramIcon,
                    title = "Telegram",
                ...
                AlertDialog(
                    ...
                    text = {
                        Column {
                            ...
                            Text("作者：andyhang1980@github (基于 WeKit & WAuxiliary)")
                        }
                    },
                    confirmButton = {
