package io.github.xchat.utils.crash
...
object CrashLogsManager {
    ...
    // Unified with the run-log naming style (logs/xchat-*.log): "xchat-crash-" prefix plus a
    // dash-separated timestamp precise to the millisecond so multiple crashes per second stay unique.
    private const val CRASH_LOGS_PREFIX = "xchat-crash-"
