package io.github.xchat.dexkit.abc

import io.github.xchat.dexkit.dsl.BaseDexDelegate
import org.luckypray.dexkit.DexKitBridge

/**
 * 表示一个需要通过 DexKit 查找符号的 Feature。
 *
 * 实现类通过 [io.github.xchat.dexkit.dsl.dexClass] / [io.github.xchat.dexkit.dsl.dexMethod] / [io.github.xchat.dexkit.dsl.dexConstructor] 工厂函数声明委托属性，
...
interface IResolveDex {
     ...
     * 供 [io.github.xchat.dexkit.cache.DexCacheManager] 持久化。
     */
