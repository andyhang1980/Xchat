package io.github.xchat.ui.utils.theme
...
import io.github.xchat.ui.utils.theme.ThemeSettings.applyToWechat
import io.github.xchat.ui.utils.theme.ThemeSettings.colorSpec
import io.github.xchat.ui.utils.theme.ThemeSettings.dynamicWallpaper
import io.github.xchat.ui.utils.theme.ThemeSettings.paletteStyle
import io.github.xchat.ui.utils.theme.ThemeSettings.seedColor
 ...
 * - the UI injected into WeChat ([io.github.xchat.ui.utils.InjectedUiTheme]) + native recoloring ([io.github.xchat.features.items.beautify.MonetEngine]) only
...
object ThemeSettings {
    ...
    /**
     * Whether the custom color also applies to WeChat itself (injected Xchat ComposeUI + native
     * recoloring via [io.github.xchat.features.items.beautify.MonetEngine]). Does NOT take effect live — requires restarting WeChat.
     */
